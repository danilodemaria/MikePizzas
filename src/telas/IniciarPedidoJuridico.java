...
public final class IniciarPedidoJuridico extends javax.swing.JFrame {
    ...
    public ArrayList<Juridica> listaJuridico = new ArrayList<>();
    ...
    public IniciarPedidoJuridico() throws SQLException {
        initComponents();
    ...
    public void preencheComboBox() throws SQLException {
        ...
        listaJuridico = Juridica.buscaJuridico();
        ...
        for (int i = 0; i < listaJuridico.size(); i++) {
            comboJuridico.addItem(listaJuridico.get(i).getNome());
        }
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                    ...
                                    .addGap(62, 62, 62)
                                    .addComponent(comboJuridico, javax.swing.GroupLayout.PREFERRED_SIZE, 169, javax.swing.GroupLayout.PREFERRED_SIZE))))))
    ...
    private void buttonSalvaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSalvaActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(null, "Deseja realmente cadastrar o pedido abaixo?\n\n" + mensagem, "Aviso",
            ...
            if (pedido.insereJuridico(pedido)) {
    ...
    private void atualizaPedido() {
        ...
        for (int i = 0; i < listaJuridico.size(); i++) {
            if (aux.equals(listaJuridico.get(i).getNome())) {
                id = i;
            }
        }
        pedido.setNome_cliente(comboJuridico.getSelectedItem().toString());
        pedido.setId_cliente(listaJuridico.get(id).getId());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new IniciarPedidoJuridico().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(IniciarPedidoJuridico.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
