...
public class CadastraBebida extends javax.swing.JFrame {

    public CadastraBebida() {
        initComponents();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(textPreco, javax.swing.GroupLayout.PREFERRED_SIZE, 262, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void buttonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonCadastrarActionPerformed
        ...
        // Setando a bebida
        nova.setNome(textNome.getText().toUpperCase());
        nova.setPreco(Double.parseDouble(textPreco.getText()));

        // Se a bebida for cadastrada com sucesso
        if (nova.cadastrar(nova)) {
            if (JOptionPane.showConfirmDialog(null, "Bebida cadastrada, inserir novamente?", "Aviso",
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastraBebida().setVisible(true);
            }
        });
    }
