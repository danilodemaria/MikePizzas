...
public class ListarPedidoJuridico extends javax.swing.JFrame {

    ArrayList<Pedido> lista = new ArrayList<>();
    Pedido pedido = new Pedido();
    public ListarPedidoJuridico() throws SQLException {
        initComponents();
    ...
    public void preencheTabela() throws SQLException{
        lista = pedido.buscaPedidosJuridicos();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Listar Pedidos Juridico");
    ...
    private void buttonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonBuscarActionPerformed
        // TODO add your handling code here:
        int column = 0;
        int row = tabelaJuridico.getSelectedRow();
        int opcao = Integer.parseInt(tabelaJuridico.getModel().getValueAt(row, 0).toString());
        ...
        for(int i=0;i<lista.size();i++){
            if(opcao == lista.get(i).getId()){
                try {
                    ...
                    Logger.getLogger(ListarPedidoJuridico.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListarPedidoJuridico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new ListarPedidoJuridico().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(ListarPedidoJuridico.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
