 ...
 */
public class ListarBebida extends javax.swing.JFrame {

    /**
     * Creates new form ListarBebida
     */
    public ListarBebida() throws SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Listagem de Bebidas");

        jLabel1.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel1.setText("Lista de Bebidas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListarBebida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(ListarBebida.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
